...
export function BoardTaskCard({
  ...
  return (
    <KanbanItem
      asHandle
      value={item.id}
      className={`group rounded-lg border p-2 text-card-foreground shadow-[0_1px_3px_rgba(0,0,0,0.3)] transition-[background-color,border-color,box-shadow,transform] duration-300 ease-out focus:outline-none cursor-pointer hover:-translate-y-[1px] ${
        item.type === "note"
