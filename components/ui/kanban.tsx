    ...
    <KanbanColumnContext.Provider value={columnContext}>
      ...
      >
        <ColumnPrimitive
          ...
          style={composedStyle}
          className={cn(
            "flex size-full flex-col gap-2.5 p-2.5 aria-disabled:pointer-events-none aria-disabled:opacity-50",
            {
  ...
  return (
    <KanbanItemContext.Provider value={itemContext}>
      <ItemPrimitive
        ...
        style={composedStyle}
        className={cn(
          "focus-visible:outline-hidden focus-visible:border-foreground/15",
          {
            "touch-none select-none": asHandle,
            "cursor-default": context.flatCursor,
            "data-dragging:cursor-grabbing": !context.flatCursor,
