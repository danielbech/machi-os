                ...
                if (seg.type === "weekend") {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <span className="text-[9px] font-medium text-foreground/35 bg-background border border-primary/30 rounded-md px-1 py-2.5 [writing-mode:vertical-lr] rotate-180 tracking-widest uppercase leading-none">
                          Weekend
                        </span>
                      </div>
                    </div>
