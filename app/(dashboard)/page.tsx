                ...
                if (seg.type === "weekend") {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <span className="text-[9px] font-medium text-foreground/35 bg-background border border-primary/30 rounded-full px-1.5 py-4 [writing-mode:vertical-lr] rotate-180 tracking-widest uppercase leading-none">
                          Weekend
                        </span>
                      </div>
                    </div>
